...
const Career = () => {
  useEffect(() => {
    document.title = "Careers | Join Acuity Groups - Facility Management Jobs";
    window.scrollTo(0, 0);
  }, []);
      ...
      <section className="relative bg-gradient-to-br from-blue-900 to-blue-700 text-white py-24 md:py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            ...
            Facility Management, Security Services, Soft Services, Pest Control,
            Housekeeping, and Business Solutions across India.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto mt-4">
              ...
              rewarding performance, and helping employees grow both personally
              and professionally.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-r from-blue-800 to-blue-700 rounded-3xl p-12 text-center text-white shadow-xl">
            ...
            <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
              Send your updated resume and relevant documents via WhatsApp. Our
