...
import bannerImage from "../../images/attibelemap.jpg";
  ...
  return (
    <div className="bg-white text-gray-800">
      <Helmet>
        ...
        <meta
          name="description"
          content="Professional Integrated Facility Management Services in Attibele Bangalore including housekeeping, security services, pest management, maintenance and manpower outsourcing for industries and commercial properties."
        />
        <link
          rel="canonical"
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold text-blue-900 mb-6">
          Professional Facility Management Company in Attibele
        </h2>

        <p className="text-lg text-gray-700 leading-8 mb-5">
          Acuity Groups provides Integrated Facility Management Services in
          Attibele Bangalore for industrial units, warehouses, manufacturing
          facilities, logistics hubs, apartments and commercial establishments.
        </p>

        <p className="text-lg text-gray-700 leading-8">
          Our trained team manages daily operations through housekeeping,
            ...
            {[
              ...
              >
                ...
                <p className="text-gray-600">
                  ...
                  industrial, residential and commercial facility requirements.
                </p>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            {
              q: "Do you provide facility management services in Attibele?",
              a: "Yes, we provide complete integrated facility management solutions throughout Attibele and nearby industrial areas.",
            },
            {
              q: "Do you provide housekeeping services for industries?",
              a: "Yes, we provide industrial housekeeping and cleaning services for factories, warehouses and manufacturing units.",
            },
            {
              q: "Do you provide security services in Attibele?",
              a: "Yes, we provide trained security guards for industries, apartments, warehouses and commercial properties.",
            },
            {
