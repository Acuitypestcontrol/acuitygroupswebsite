    ...
    <div className="bg-white text-gray-800">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 leading-8 mb-6">
              ...
              Services in Doddaballapur Bangalore for factories, industrial
              units, warehouses, logistics parks and manufacturing facilities.
            </p>
      ...
      <section className="py-16 bg-gray-100 text-center px-6">
        <h2 className="text-4xl font-bold text-blue-900 mb-4">
          Looking for Facility Management Services in Doddaballapur?
        </h2>
