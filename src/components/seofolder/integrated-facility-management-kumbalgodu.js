...
import bannerImage from "../../images/kumbalagodumap.jpg";
  ...
  return (
    <div className="bg-white text-gray-800">
      <Helmet>
        ...
        <meta
          name="description"
          content="Professional Integrated Facility Management Services in Kumbalgodu Bangalore including housekeeping, security services, pest management, maintenance and manpower outsourcing for industries and commercial properties."
        />
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold text-blue-900 mb-6">
          Professional Facility Management Company in Kumbalgodu
        </h2>

        <p className="text-lg text-gray-700 leading-8 mb-5">
          Acuity Groups provides Integrated Facility Management Services in
          Kumbalgodu Bangalore for industrial parks, warehouses, factories,
          institutions, apartment communities and commercial establishments.
        </p>
        ...
        <p className="text-lg text-gray-700 leading-8">
          ...
          manpower outsourcing solutions to ensure smooth operations.
        </p>
      </section>
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            "Trained Facility Management Workforce",
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            {
              q: "Do you provide facility management services in Kumbalgodu?",
              a: "Yes, we provide complete integrated facility management solutions throughout Kumbalgodu and nearby areas.",
            },
            {
              q: "Do you provide industrial housekeeping services?",
              a: "Yes, we provide industrial housekeeping and cleaning services for factories, warehouses and manufacturing units.",
            },
            {
              q: "Do you provide security services in Kumbalgodu?",
              a: "Yes, we provide trained security guards for industries, apartments and commercial properties.",
            },
            {
              q: "Do you provide manpower outsourcing services?",
              a: "Yes, we provide skilled and unskilled manpower outsourcing services for industrial and commercial facilities.",
            },
          ].map((faq, index) => (
