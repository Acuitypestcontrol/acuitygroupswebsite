...
const Careers = () => {
  ...
  const jobPostingSchema = {
    ...
    description:
      "Explore career opportunities in pest control, operations, and business support.",
  ...
  return (
    <>
      <Helmet>
        <link rel="canonical" href="https://acuitygroups.in/careers" />
        <title>Careers | Join Acuity Integrated Facility Management Team</title>
        <meta
          name="description"
          content="Build your career with a leader. Explore job openings in pest control, operations, and business support at Acuity Groups Bangalore. Apply via email today!"
        />
        <meta
          name="keywords"
          content="careers at Acuity, facility management jobs, pest control technician, operations supervisor, business support executive, Bangalore jobs, pest control careers"
        />
        ...
        <meta property="og:url" content="https://acuitygroups.in/careers" />
        <meta
          property="og:title"
        ...
        <meta
          ...
          content="Explore exciting career opportunities at Acuity Integrated Facility Management. We're hiring for pest control, operations, and business support roles in Bangalore."
        />
        <meta
          property="og:image"
        ...
        <meta
          ...
          content="Join our team – pest control, operations, business support. Apply via email."
        />
        <meta
          name="twitter:image"
          content="https://acuitygroups.in/static/media/careers-og.jpg"
              ...
              {jobs.map((job, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <a
                      href={`mailto:info@acuitygroups.in?subject=Application for ${job.title}`}
        ...
        <section className="py-20 px-6 md:px-12">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-gray-600 text-lg mb-8">
              Send your resume to our HR team and become part of a growing
