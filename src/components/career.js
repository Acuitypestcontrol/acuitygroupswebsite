...
const Careers = () => {
  useEffect(() => {
    document.title =
      "Careers | Join Acuity Integrated Facility Management Team";
    window.scrollTo(0, 0);
  }, []);
    ...
    <div className="bg-white text-gray-800 overflow-hidden font-['Poppins',system-ui,sans-serif]">
          ...
          <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100 inline-block w-full md:w-auto min-w-[300px]">
            <div className="space-y-3 text-left">
              ...
              <div className="flex items-center gap-3 text-gray-700">
                ...
                <span>
                  No-28/2, KVO-08, 1st Floor, near Sun Jupiter School, JP Nagar
      ...
      {/* <section className="py-8 border-t border-gray-200 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-600">
          <a href="tel:9941229005" className="flex items-center gap-2 hover:text-blue-800 transition">
            <Phone size={16} className="text-blue-800" />
            <span>+91 98765 43210</span>
          </a>
          <a href="mailto:info@acuitygroups.in" className="flex items-center gap-2 hover:text-blue-800 transition">
            <Mail size={16} className="text-blue-800" />
            <span>info@acuitygroups.in</span>
          </a>
          <div className="flex items-center gap-2">
            <MapPin size={16} className="text-blue-800" />
            <span>2nd Floor, KVO-08, No-28/2, near Sun Jupiter School

JP Nagar 6th Phase, Yelachenahalli

Bengaluru, Karnataka 560078</span>
          </div>
        </div>
      </section> */}
