        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-500 text-lg leading-relaxed mb-8">
              We specialize in integrated facility management services including
              housekeeping services, security guard services, manpower
              outsourcing, pest management, electrical maintenance, repair &
              maintenance solutions and corporate support services.
            </p>
            <p className="text-gray-500 text-lg leading-relaxed mb-10">
              With advanced operational systems, trained professionals and 24/7
              customer support, Acuity Groups has become a trusted partner for
              apartments, IT companies, factories, hospitals, warehouses,
              educational institutions and commercial establishments across
              India.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-5 mb-10">
              ...
              <div className="flex items-center gap-4">
                <div className="w-4 h-4 rounded-full bg-blue-900"></div>
                <p className="text-gray-800 text-lg">Pest Control Solutions</p>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-4 h-4 rounded-full bg-blue-900"></div>
                <p className="text-gray-800 text-lg">Electrical Maintenance</p>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-4 h-4 rounded-full bg-blue-900"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { title: "Competitive Pricing", Icon: TrendingUp, color: "teal" },
