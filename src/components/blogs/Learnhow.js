          ...
          <div className="lg:col-span-6 space-y-8">
              ...
              <div className="space-y-4">
                <div className="bg-red-50 border-l-4 border-red-500 p-5 rounded-xl hover:shadow-md transition">
                  ...
                  <p className="text-gray-700">
                    ...
                    maintenance, reducing downtime, avoiding costly repairs, and
                ...
                <div className="bg-green-50 border-l-4 border-green-500 p-5 rounded-xl hover:shadow-md transition">
                  ...
                  <p className="text-gray-700">
                    ...
                    operational expenses, and environmental impact over the long
                    term.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed text-lg">
                ...
                and well-maintained environments. Investing in workplace quality
                can improve morale, increase productivity, and strengthen
                employee retention.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-2xl p-6 border border-indigo-100">
              ...
              <p className="text-gray-700">
                ...
                FM isn't just maintenance—it's a competitive advantage.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-indigo-100 leading-relaxed text-lg">
                ...
                through strategic planning, preventive maintenance, technology,
                and sustainable solutions. Our expertise ensures your facility
                operates efficiently while supporting long-term growth and
                success.
              </p>
