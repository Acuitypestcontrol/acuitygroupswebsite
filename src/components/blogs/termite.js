  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="termite control, termite treatment, home protection, termite inspection, pest control, termite prevention, Acuity Groups"
        />
        ...
        <meta
          property="og:title"
          content="Termite Control: Complete Home Protection Guide | Acuity Groups"
        />
        <meta
          property="og:description"
          content="Save your wooden furniture from costly termite damage. Learn early signs of infestation, DIY prevention tips, and when to get professional pest control."
        />
        <meta
          property="og:image"
        ...
        <meta
          name="twitter:title"
          content="Termite Control: Complete Home Protection Guide"
        />
        <meta
            ...
            <div className="lg:col-span-6 space-y-8">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-6 border-l-8 border-blue-600">
                ...
                <ul className="list-disc pl-5 text-gray-700 space-y-2">
                  ...
                  <li>
                    Use termite barriers and bait stations as preventive
                    measures
                  </li>
              ...
              <div className="bg-white rounded-2xl shadow-md p-6 md:p-8">
                <p className="text-xl text-gray-700 leading-relaxed border-l-4 border-blue-500 pl-5 italic">
                  Termites cause billions of dollars in property damage each
                  year. They silently eat away at wooden structures, often going
              ...
              <div id="why-dangerous" className="scroll-mt-24">
                ...
                <ul className="space-y-2 list-disc pl-5 text-gray-700">
                  ...
                  <li>
                    <strong>Hidden destruction:</strong> They eat from the
                    inside out, often undetected for years.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Decreased property value:</strong> Termite history
                    can make it hard to sell your home.
                  </li>
                </ul>
              </div>
              ...
              <div id="prevention" className="scroll-mt-24">
                ...
                <ul className="space-y-2 list-disc pl-5 text-gray-700">
                  ...
                  <li>
                    <strong>Keep firewood and lumber away:</strong> Store wood
                    at least 20 feet from the foundation and elevate it.
                  </li>
                  <li>
              ...
              <div id="professional" className="scroll-mt-24">
                ...
                <ul className="space-y-2 list-disc pl-5 text-gray-700">
                  <li>
                    Accurate inspection with moisture meters and thermal
                    imaging.
                  </li>
              ...
              <div id="treatment-options" className="scroll-mt-24">
                ...
                <ul className="space-y-2 list-disc pl-5 text-gray-700">
                  ...
                  <li>
                    <strong>Bait systems:</strong> Stations placed in the
                    ground; termites carry poison back to the colony.
                  </li>
                  <li>
