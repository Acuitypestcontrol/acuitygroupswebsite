...
const TermiteControlGuide = () => {
  ...
  useEffect(() => {
    ...
    // Title & Meta
    document.title = "Termite Control: Complete Home Protection Guide | Acuity Groups";
    ...
    // Open Graph
    updateMeta("og:title", "Termite Control: Complete Home Protection Guide | Acuity Groups", true);
    updateMeta("og:description", metaDescription, true);
    updateMeta("og:image", "https://acuitygroups.com/static/media/termite.jpg", true);
    updateMeta("og:url", "https://acuitygroups.com/blogs/termite-control-guide", true);
    updateMeta("og:type", "article", true);
    updateMeta("og:site_name", "Acuity Groups", true);

    // Twitter Card
    updateMeta("twitter:card", "summary_large_image");
    updateMeta("twitter:title", "Termite Control: Complete Home Protection Guide");
    updateMeta("twitter:description", metaDescription);
    updateMeta("twitter:image", "https://acuitygroups.com/static/media/termite.jpg");
    ...
    canonical.href = "https://acuitygroups.com/blogs/termite-control-guide";
    ...
    const articleData = {
      ...
      mainEntityOfPage: {
        "@type": "WebPage",
        "@id": "https://acuitygroups.com/blogs/termite-control-guide",
      },
    };
    ...
    const breadcrumbData = {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Termite Control", item: "https://acuitygroups.com/blogs/termite-control-guide" },
      ],
    };
  ...
  const shareUrl = encodeURIComponent("https://acuitygroups.com/blogs/termite-control-guide");
  const shareTitle = encodeURIComponent("Termite Control: Complete Home Protection Guide | Acuity Groups");
  ...
  const stats = [
    { value: "1000+", label: "Homes Protected", icon: <Home className="text-blue-600 w-6 h-6" /> },
    { value: "99%", label: "Elimination Rate", icon: <Award className="text-blue-600 w-6 h-6" /> },
    ...
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-50 text-gray-800 font-sans relative">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-6 border-l-8 border-blue-600">
              ...
              <ul className="list-disc pl-5 text-gray-700 space-y-2">
                <li>Eliminate moisture – fix leaks and improve drainage around foundation</li>
                <li>Keep firewood, lumber, and wood debris away from the house</li>
                <li>Regularly inspect crawl spaces, basements, and wooden structures</li>
                <li>Use termite barriers and bait stations as preventive measures</li>
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 md:p-8">
              <p className="text-xl text-gray-700 leading-relaxed border-l-4 border-blue-500 pl-5 italic">
                Termites cause billions of dollars in property damage each year. They silently eat away at wooden structures, often going unnoticed until major damage is done. Early detection and prevention are your best defenses.
              </p>
            </div>
            ...
            <div className="my-2">
              ...
              <div className="flex justify-between items-center mt-2 text-sm text-gray-500">
                ...
                <span className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full">Pest Control</span>
              </div>
            </div>
            ...
            <div id="why-dangerous" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Bug size={28} className="text-blue-500" /> Why Termites Are Dangerous
              </h2>
              <ul className="space-y-2 list-disc pl-5 text-gray-700">
                <li><strong>Structural damage:</strong> Termites weaken wooden beams, floors, and walls – repairs can cost lakhs.</li>
                <li><strong>Hidden destruction:</strong> They eat from the inside out, often undetected for years.</li>
                <li><strong>Rapid reproduction:</strong> A single queen can lay thousands of eggs daily.</li>
                <li><strong>Decreased property value:</strong> Termite history can make it hard to sell your home.</li>
              </ul>
            </div>
            ...
            <div id="signs" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <AlertTriangle size={28} className="text-blue-500" /> Signs of Termite Infestation
              </h2>
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={i} className="flex items-start gap-2 bg-white p-3 rounded-xl shadow-sm">
            ...
            <div id="prevention" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Shield size={28} className="text-blue-500" /> How to Prevent Termites
              </h2>
              <ul className="space-y-2 list-disc pl-5 text-gray-700">
                <li><strong>Eliminate moisture:</strong> Fix leaky pipes, ensure proper drainage, use dehumidifiers in damp areas.</li>
                <li><strong>Keep firewood and lumber away:</strong> Store wood at least 20 feet from the foundation and elevate it.</li>
                <li><strong>Regular inspections:</strong> Check crawl spaces, basements, attics, and wooden structures every season.</li>
                <li><strong>Use physical barriers:</strong> Install stainless steel mesh or crushed stone under slabs.</li>
                <li><strong>Termite bait stations:</strong> Placed around the perimeter, they attract and poison termites.</li>
                <li><strong>Chemical soil treatments:</strong> A barrier of termiticide around the foundation.</li>
                <li><strong>Remove wood debris:</strong> Clear stumps, old tree roots, and construction wood near the house.</li>
              </ul>
            </div>

            {/* Pro Tip Box */}
            <div className="bg-gray-100 rounded-2xl p-6 border-l-4 border-gray-600">
              <p className="font-bold text-gray-800 text-lg mb-2 flex items-center gap-2">💡 Pro Tip</p>
              <p className="text-gray-700">Never store cardboard boxes directly on basement floors – termites love the cellulose. Use plastic bins instead.</p>
            </div>

            {/* When to Call a Professional */}
            <div id="professional" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Home size={28} className="text-blue-500" /> When to Call a Professional
              </h2>
              <p className="text-gray-700 leading-relaxed mb-3">If you see any signs of termites, DIY treatments are rarely enough. Professional termite control offers:</p>
              <ul className="space-y-2 list-disc pl-5 text-gray-700">
                <li>Accurate inspection with moisture meters and thermal imaging.</li>
            ...
            <div id="treatment-options" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Sparkles size={28} className="text-blue-500" /> Professional Termite Treatment Options
              </h2>
              <ul className="space-y-2 list-disc pl-5 text-gray-700">
                <li><strong>Liquid soil treatment:</strong> Creates a continuous chemical barrier around the foundation – lasts 5–10 years.</li>
                <li><strong>Bait systems:</strong> Stations placed in the ground; termites carry poison back to the colony.</li>
                <li><strong>Wood treatment:</strong> Borate sprays applied to exposed wood (for new construction or renovations).</li>
                <li><strong>Fumigation (tenting):</strong> For drywood termites – entire home covered, gas kills all termites.</li>
              </ul>
            </div>

            {/* Did you know box */}
            <div className="bg-amber-50 rounded-2xl p-6 text-center border border-amber-200">
              <p className="font-bold text-amber-800 text-lg flex items-center justify-center gap-2">🪵 Did you know?</p>
              <p className="text-gray-700">A mature termite colony can eat about a pound of wood per day. Over a year, that's the equivalent of a 10‑foot wooden 2×4.</p>
            </div>

            {/* Final CTA */}
            <div className="bg-blue-50 p-6 rounded-2xl text-center border border-blue-200">
              <p className="text-gray-800 text-lg">
                Don't wait for visible damage. Annual professional inspections are the best defense. If you spot mud tubes or hollow‑sounding wood, call Acuity Groups immediately for a free inspection and effective termite control.
              </p>
              <div className="mt-4">
          ...
          <aside className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-100">
              <div className="w-24 h-24 mx-auto rounded-full overflow-hidden bg-gray-200 mb-4">
                <img src={Termite} alt="Termite Control Expert" className="w-full h-full object-cover" />
              </div>
              <h3 className="font-bold text-xl">Acuity Pest Control Team</h3>
              <p className="text-gray-500 text-sm mt-1">Termite Control Specialists</p>
              <p className="text-gray-600 text-sm mt-3">15+ years in termite inspection and treatment.</p>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3 items-center group">
                  ...
                  <Link to="/blogs/mosquito-prevention" className="text-blue-600 group-hover:text-blue-700 group-hover:underline transition text-sm font-medium flex-1">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-100 rounded-2xl p-6 shadow-md border border-blue-100 text-center">
              ...
              <h3 className="font-bold text-blue-900 text-lg mb-2">Termite Inspection</h3>
              <p className="text-gray-700 text-sm mb-4">Get a free professional inspection for your home.</p>
              ...
              <div className="mt-4 rounded-lg overflow-hidden">
                <img src={Termite} alt="Termite" className="w-full h-20 object-cover" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 text-center shadow-lg border">
              ...
              <p className="font-semibold text-gray-800">Trusted by 1000+ Homeowners</p>
              <p className="text-xs text-gray-500 mt-1">Safe | Effective | Long‑lasting</p>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 border-t border-gray-200">
        ...
        <div className="space-y-4">
          {[
            { q: "What are the early signs of termites?", a: "Mud tubes on walls, hollow-sounding wood, discarded wings near windows, frass (termite droppings), and bubbling paint." },
            { q: "Can I treat termites myself?", a: "DIY methods may help small infestations, but professional treatment is recommended for effective long‑term elimination." },
            { q: "How often should I get a termite inspection?", a: "At least once a year – more frequently if you live in a high‑risk area or have had past infestations." },
          ].map((faq, idx) => (
      ...
      <section className="relative bg-gradient-to-r from-blue-800 via-cyan-800 to-blue-900 text-white py-16 text-center overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <img src={Termite} alt="background pattern" className="w-full h-full object-cover" />
        </div>
        <div className="relative max-w-3xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Suspect Termites in Your Home?</h2>
          <p className="text-blue-100 text-lg mb-8">Get a free professional inspection – protect your investment.</p>
