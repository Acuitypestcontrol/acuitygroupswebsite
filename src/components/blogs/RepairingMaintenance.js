...
const PreventiveMaintenanceBlog = () => {
  ...
  useEffect(() => {
    ...
    updateMeta(
      "keywords",
      "preventive maintenance, asset management, equipment maintenance, facility maintenance, scheduled inspections, Acuity Groups",
    );
    ...
    updateMeta(
      "og:image",
      "https://acuitygroups.com/static/media/RepairingMaintenance.jpg",
      true,
    );
    updateMeta(
      "og:url",
    ...
    const articleData = {
      ...
      image: "https://acuitygroups.com/static/media/RepairingMaintenance.jpg",
