  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="security services, professional security, business security, access control, surveillance, emergency response, Acuity Groups"
        />
        ...
        <meta
          ...
          content="Protect your business with professional security services: crime prevention, emergency response, access control, and enhanced customer confidence. Expert insights from Acuity Groups."
        />
        <meta
          property="og:image"
        ...
        <meta
          name="twitter:title"
          content="Why Every Business Needs Professional Security Services"
        />
        <meta
          name="twitter:description"
          content="Protect your business with professional security services: crime prevention, emergency response, access control, and enhanced customer confidence."
        />
        <meta
          name="twitter:image"
          content="https://www.acuitygroups.in/static/media/why5.jpg"
