...
const SecurityServicesBlog = () => {
  ...
  useEffect(() => {
    ...
    updateMeta("og:image", "https://acuitygroups.com/static/media/why5.jpg", true);
    updateMeta("og:url", "https://acuitygroups.com/blogs/security-services", true);
    ...
    updateMeta("twitter:image", "https://acuitygroups.com/static/media/why5.jpg");
    ...
    const breadcrumbData = {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Security Services", item: "https://acuitygroups.com/blogs/security-services" },
      ],
    };
  ...
  const shareUrl = encodeURIComponent("https://acuitygroups.com/blogs/security-services");
  ...
  const stats = [
    { value: "400+", label: "Businesses Served", icon: <Building className="text-red-600 w-6 h-6" /> },
    { value: "98%", label: "Client Satisfaction", icon: <Award className="text-red-600 w-6 h-6" /> },
    { value: "24/7", label: "Emergency Support", icon: <Clock className="text-red-600 w-6 h-6" /> },
    { value: "15+", label: "Years Experience", icon: <Calendar className="text-red-600 w-6 h-6" /> },
  ];
    ...
    <div className="bg-gradient-to-br from-red-50 via-white to-gray-50 text-gray-800 font-sans relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="text-sm text-gray-500 mb-8" aria-label="Breadcrumb">
          <ol className="flex flex-wrap items-center gap-2">
            ...
            <li><Link to="/blogs/allblogs" className="hover:text-red-600 transition">Blogs</Link></li>
            <li className="text-gray-400">/</li>
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 md:p-8">
              <p className="text-xl text-gray-700 leading-relaxed border-l-4 border-red-500 pl-5 italic">
                Security is one of the most important aspects of any business. Whether you operate an office, retail store, hotel, hospital, or industrial facility, professional security services help protect people, assets, and operations from potential risks.
              </p>
            </div>
            ...
            <div id="protecting" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Shield size={28} className="text-red-500" /> Protecting People and Property
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Trained security personnel provide a visible deterrent against theft, vandalism, unauthorized access, and other security threats. Their presence helps create a safer environment for employees, visitors, and customers.
              </p>
            </div>
            ...
            <div className="my-2">
              ...
              <div className="flex justify-between items-center mt-2 text-sm text-gray-500">
                ...
                <span className="bg-red-100 text-red-700 px-2 py-0.5 rounded-full">Security Tech</span>
              </div>
            </div>
            ...
            <div id="benefits" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                <BadgeCheck size={28} className="text-red-500" /> Key Benefits of Professional Security Services
              </h2>
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  { title: "Crime Prevention", desc: "Visible security personnel discourage criminal activities.", icon: Shield },
                  { title: "Emergency Response", desc: "Quick action during emergencies minimizes risks and damages.", icon: AlertTriangle },
                  { title: "Access Control", desc: "Monitor and manage entry points to prevent unauthorized access.", icon: Eye },
                  { title: "Customer Confidence", desc: "A secure environment improves trust and business reputation.", icon: Building },
                ].map((item, idx) => (
                  <div key={idx} className="group bg-white rounded-xl shadow-md p-6 border-l-4 border-red-500 hover:shadow-lg transition">
            ...
            <div id="beyond-guarding" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Eye size={28} className="text-red-500" /> Security Beyond Guarding
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Modern security services include surveillance monitoring, visitor management, emergency preparedness, incident reporting, and access control systems. These solutions work together to provide complete protection for businesses.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-2xl p-6 border border-red-100">
              <h3 className="text-xl font-bold text-red-800 mb-2 flex items-center gap-2">💡 Did You Know?</h3>
              <p className="text-gray-700">
                Businesses with visible security personnel experience up to 60% fewer theft incidents and 40% faster emergency response times. Professional security isn't just protection—it's a business asset.
              </p>
            </div>

            {/* Why Choose Acuity Groups */}
            <div id="why-acuity" className="bg-gradient-to-br from-red-600 to-red-800 text-white p-8 rounded-2xl shadow-xl scroll-mt-24">
              <h2 className="text-3xl font-bold mb-4 flex items-center gap-2">
                <Sparkles size={28} className="text-white" /> Why Choose Acuity Groups?
              </h2>
              <p className="text-red-100 leading-relaxed text-lg mb-6">
                Acuity Groups provides trained and professional security personnel for offices, commercial buildings, residential communities, hospitals, hotels, and industrial facilities. Our customized security solutions ensure safety, compliance, and peace of mind.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link to="/contactus" className="inline-flex items-center gap-2 bg-white text-red-700 px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition shadow-lg">
            ...
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white p-8 rounded-2xl shadow-xl">
              ...
              <p className="text-gray-200 text-lg leading-relaxed">
                Professional security services are essential for protecting businesses, employees, customers, and assets. Investing in reliable security solutions helps create a safe environment, reduces risks, and supports long-term business success. Partner with Acuity Groups to build a robust security framework.
              </p>
            </div>

            {/* Back to blogs */}
            <div className="pt-4 border-t border-gray-200">
              <Link to="/blogs/allblogs" className="text-red-600 hover:text-red-700 font-medium inline-flex items-center gap-1">
                ← Back to all blogs
              </Link>
            </div>
          </div>
          ...
          <aside className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-100">
              <div className="w-24 h-24 mx-auto rounded-full overflow-hidden bg-gray-200 mb-4">
                <img src={Why8} alt="Security Expert" className="w-full h-full object-cover" />
              </div>
              <h3 className="font-bold text-xl">Acuity Security Team</h3>
              <p className="text-gray-500 text-sm mt-1">Security Specialists</p>
              <p className="text-gray-600 text-sm mt-3">15+ years in corporate and industrial security.</p>
              ...
              <ul className="space-y-4">
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={Why5} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                  <Link to="/blogs/TheImportanceFacilities" className="text-red-600 group-hover:text-red-700 group-hover:underline transition text-sm font-medium flex-1">
                    The Importance of Facilities Management
                  </Link>
                </li>
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={Why7} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                  <Link to="/blogs/healthcare-facility-management" className="text-red-600 group-hover:text-red-700 group-hover:underline transition text-sm font-medium flex-1">
                    Healthcare Facility Management
                  </Link>
                </li>
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={Why} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                  <Link to="/blogs/manufacturing-facility-management" className="text-red-600 group-hover:text-red-700 group-hover:underline transition text-sm font-medium flex-1">
            ...
            <div className="bg-gradient-to-br from-red-50 to-orange-100 rounded-2xl p-6 shadow-md border border-red-100 text-center">
              ...
              <h3 className="font-bold text-red-900 text-lg mb-2">Security Assessment</h3>
              <p className="text-gray-700 text-sm mb-4">Get a free, no-obligation security review for your business.</p>
              <Link to="/contactus" className="block text-center bg-red-600 text-white py-2.5 rounded-full hover:bg-red-700 transition shadow">
                Request a Quote
              </Link>
              <div className="mt-4 rounded-lg overflow-hidden">
                <img src={Why7} alt="Security" className="w-full h-20 object-cover" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 text-center shadow-lg border">
              ...
              <p className="font-semibold text-gray-800">Trusted by 400+ Businesses</p>
              <p className="text-xs text-gray-500 mt-1">Vigilant | Professional | Reliable</p>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 border-t border-gray-200">
        ...
        <div className="space-y-4">
          {[
            { q: "Why is security important for businesses?", a: "Security protects people, assets, and operations from theft, vandalism, unauthorized access, and emergencies – building trust and reducing liability." },
            { q: "What services do professional security companies offer?", a: "They provide uniformed guards, CCTV surveillance, access control, visitor management, emergency response, and incident reporting." },
            { q: "How does Acuity Groups ensure security quality?", a: "Acuity Groups uses trained personnel, background checks, regular audits, and modern technology to deliver reliable security solutions." },
          ].map((faq, idx) => (
            <div key={idx} className="bg-white rounded-xl shadow-md overflow-hidden">
              ...
              >
                {faq.q}
                <span className="text-red-600 text-2xl">{activeFaq === idx ? "−" : "+"}</span>
              </button>
              {activeFaq === idx && (
      ...
      <section className="relative bg-gradient-to-r from-red-800 via-orange-800 to-red-900 text-white py-16 text-center overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <img src={Why} alt="background pattern" className="w-full h-full object-cover" />
        </div>
        <div className="relative max-w-3xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Don't Leave Security to Chance</h2>
          <p className="text-red-100 text-lg mb-8">Partner with Acuity Groups for professional, reliable security services.</p>
          <div className="flex flex-wrap justify-center gap-5">
            <Link to="/contactus" className="inline-flex items-center gap-2 bg-white text-red-800 px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition shadow-lg">
