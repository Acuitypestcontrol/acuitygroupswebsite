...
const EducationFacilityManagementBlog = () => {
  ...
  useEffect(() => {
    // Page title
    document.title =
      "Why Schools & Colleges Need Professional Facility Management | Acuity Groups";
    ...
    canonical.href = "https://acuitygroups.in/blogs/EducationIndustry";
    ...
    ogImage.setAttribute(
      "content",
      "https://acuitygroups.com/static/media/school1.jpg",
    );
    ...
    ogUrl.setAttribute(
      "content",
      "https://acuitygroups.in/blogs/EducationIndustry",
    );
