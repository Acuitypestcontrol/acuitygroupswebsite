...
import { Calendar, User, Shield, Sparkles, Wrench, Bug, ArrowRight, CheckCircle, Building, Thermometer, Droplets, BarChart3, Award, Clock, Phone } from "lucide-react";
...
const EducationFacilityManagementBlog = () => {
  ...
  useEffect(() => {
    // Page title
    document.title = "Why Schools & Colleges Need Professional Facility Management | Acuity Groups";
    ...
    keywords.content =
      "school facility management, college facility management, campus security, educational facility services, housekeeping in schools, maintenance for schools, Acuity Groups, education facility management Bangalore";
    ...
    canonical.href = "https://acuitygroups.com/blogs/EducationIndustry";
    ...
    ogTitle.setAttribute("content", "Why Schools & Colleges Need Professional Facility Management | Acuity Groups");
    ...
    ogImage.setAttribute("content", "https://acuitygroups.com/static/media/school1.jpg");
    ...
    ogUrl.setAttribute("content", "https://acuitygroups.com/blogs/EducationIndustry");
    ...
    twitterTitle.setAttribute("content", "Why Schools & Colleges Need Professional Facility Management | Acuity Groups");
    ...
    const articleData = {
      ...
      image: "https://acuitygroups.com/static/media/school1.jpg",
      ...
      mainEntityOfPage: { "@type": "WebPage", "@id": "https://acuitygroups.com/blogs/EducationIndustry" },
    };
  ...
  const stats = [
    ...
    { value: "50+", label: "Schools Served", icon: <Building className="text-green-600 w-6 h-6" /> },
    ...
    <div className="bg-gradient-to-br from-gray-50 to-white text-gray-800 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <nav className="text-sm text-gray-500 mb-8" aria-label="Breadcrumb">
          <ol className="flex flex-wrap items-center gap-2">
            ...
            <li className="text-gray-400">/</li>
            <li className="text-gray-700 font-medium">Education Facility Management</li>
          </ol>
        </nav>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 md:p-8">
              <p className="text-xl text-gray-700 leading-relaxed">
                Educational institutions are responsible for providing a safe, healthy, and productive environment for students, teachers, and staff. Professional facility management helps schools and colleges maintain high standards while focusing on education.
              </p>
            </div>

            {/* Feature Cards with Icons - Enhanced */}
            <div>
              <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center gap-2">🏫 Key Facility Management Services</h2>
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="bg-white rounded-2xl shadow-md p-6 border-l-4 border-green-500 hover:shadow-lg transition">
                  ...
                  <p className="text-gray-600">Trained security personnel, CCTV surveillance, access control, and emergency response to ensure student safety.</p>
                </div>
                <div className="bg-white rounded-2xl shadow-md p-6 border-l-4 border-green-500 hover:shadow-lg transition">
                  <Sparkles className="text-green-600 w-10 h-10 mb-3" />
                  <h3 className="font-bold text-xl mb-2">Housekeeping</h3>
                  <p className="text-gray-600">Daily cleaning of classrooms, washrooms, corridors, and common areas with eco-friendly products.</p>
                </div>
                <div className="bg-white rounded-2xl shadow-md p-6 border-l-4 border-green-500 hover:shadow-lg transition">
                  <Wrench className="text-green-600 w-10 h-10 mb-3" />
                  <h3 className="font-bold text-xl mb-2">Maintenance</h3>
                  <p className="text-gray-600">Preventive and corrective maintenance for electrical, plumbing, HVAC, and building infrastructure.</p>
                </div>
                <div className="bg-white rounded-2xl shadow-md p-6 border-l-4 border-green-500 hover:shadow-lg transition">
                  <Bug className="text-green-600 w-10 h-10 mb-3" />
                  <h3 className="font-bold text-xl mb-2">Pest Management</h3>
                  <p className="text-gray-600">Safe, eco-friendly pest control to keep educational spaces hygienic and pest-free.</p>
                </div>
              </div>
            </div>
            ...
            <div className="my-4">
              ...
              <div className="flex justify-between items-center mt-2 text-sm text-gray-500">
                <span>🧹 Regular cleaning ensures a healthy learning environment</span>
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-3">🎯 Supporting Student Success</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                Students learn better in environments that are clean, organized, and comfortable. Facility management contributes to improved concentration, reduced absenteeism, and better academic outcomes.
              </p>
            ...
            <div>
              <h2 className="text-3xl font-bold mb-6">✅ Benefits of Professional Facility Management</h2>
            ...
            <div className="bg-gradient-to-r from-green-700 to-green-600 text-white p-8 rounded-2xl">
              ...
              <p className="text-green-50 text-lg leading-relaxed">
                Professional facility management helps schools and colleges provide safe, clean, and productive learning environments. Acuity Groups delivers customized solutions that support educational excellence and campus safety.
              </p>
              <div className="mt-6 flex flex-wrap gap-4">
                <Link to="/contactus" className="inline-flex items-center gap-2 bg-white text-green-700 px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition shadow-md">
          ...
          <aside className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-100">
              <div className="w-24 h-24 mx-auto rounded-full overflow-hidden bg-gray-200 mb-4">
                <img src={School1} alt="Facility Management Expert" className="w-full h-full object-cover" />
              </div>
              <h3 className="font-bold text-xl">Acuity Experts</h3>
              <p className="text-gray-500 text-sm mt-1">Facility Management Team</p>
              <p className="text-gray-600 text-sm mt-3">Specialized in educational institution services with 15+ years experience.</p>
                ...
                {relatedBlogs.map((blog, idx) => (
                  <li key={idx} className="flex gap-3 items-center group">
                    <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                      <img src={idx === 0 ? School4 : idx === 1 ? School3 : School1} alt="thumb" className="w-full h-full object-cover" />
                    </div>
                    <Link to={blog.link} className="text-green-600 group-hover:text-green-700 group-hover:underline transition text-sm font-medium flex-1">
                      {blog.title}
                    </Link>
                  </li>
                ))}
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 shadow-md border border-green-100 text-center">
              ...
              <h3 className="font-bold text-green-800 text-lg mb-2">Need Facility Management?</h3>
              <p className="text-gray-600 text-sm mb-4">Customized plans for security, housekeeping, maintenance & more.</p>
              ...
              <div className="mt-4 rounded-lg overflow-hidden">
                <img src={School4} alt="Campus" className="w-full h-20 object-cover" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 text-center shadow-sm border">
              ...
              <p className="text-gray-600 text-sm">Trusted by 50+ educational institutions</p>
              <p className="text-xs text-gray-400 mt-1">ISO Certified | 24/7 Support</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 border-t border-gray-200">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-4">
            {[
              { q: "What does facility management include for schools?", a: "It includes campus security, housekeeping, preventive maintenance, pest control, landscaping, waste management, and energy management." },
              { q: "How does facility management improve student learning?", a: "Clean, safe, and comfortable environments boost concentration, reduce absenteeism, and enhance overall academic performance." },
            ].map((faq, idx) => (
          ...
          <div className="space-y-4">
            {[
              { q: "Can small schools afford professional facility management?", a: "Yes, Acuity Groups offers scalable, cost-effective packages tailored to the size and budget of any educational institution." },
              { q: "How does Acuity Groups ensure quality?", a: "We use ISO-certified processes, regular audits, trained staff, and client feedback systems to maintain high standards." },
            ].map((faq, idx) => (
              <div key={idx+2} className="bg-white rounded-xl shadow-md overflow-hidden">
                <button onClick={() => toggleFaq(idx+2)} className="w-full text-left p-5 font-semibold text-gray-800 flex justify-between items-center hover:bg-gray-50 transition">
                  {faq.q}
                  <span className="text-green-600 text-2xl">{activeFaq === idx+2 ? "−" : "+"}</span>
                </button>
                {activeFaq === idx+2 && (
                  <div className="p-5 pt-0 text-gray-600 border-t border-gray-100">
                    {faq.a}
            ...
            <div className="rounded-xl overflow-hidden shadow-md mt-4">
              <img src={School3} alt="FAQ illustration" className="w-full h-32 object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative bg-gradient-to-r from-green-800 to-green-700 text-white py-16 text-center overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <img src={School1} alt="background pattern" className="w-full h-full object-cover" />
        </div>
        <div className="relative max-w-3xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Enhance Your Campus Experience</h2>
          <p className="text-green-100 mb-8 text-lg">Partner with Acuity Groups for reliable, professional facility management.</p>
          <div className="flex flex-wrap justify-center gap-5">
            <Link to="/contactus" className="inline-flex items-center gap-2 bg-white text-green-700 px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition shadow-lg">
