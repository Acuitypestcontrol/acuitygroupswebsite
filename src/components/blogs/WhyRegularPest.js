  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="pest management, commercial pest control, rodent control, termite treatment, preventive pest control, Acuity Groups"
        />
        ...
        <meta
          property="og:title"
          content="Why Regular Pest Control Is Essential for Businesses | Acuity Groups"
        />
        <meta
          property="og:description"
          content="Protect your business from rodents, termites, and other pests. Learn why regular pest management is vital for health, property, compliance, and brand reputation."
        />
        <meta
          property="og:image"
        ...
        <meta
          name="twitter:title"
          content="Why Regular Pest Control Is Essential for Businesses"
        />
        <meta
            ...
            <div className="lg:col-span-6 space-y-8">
              ...
              <div id="benefits" className="scroll-mt-24">
                <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                  <Shield size={28} className="text-orange-500" /> Key Benefits
              ...
              <div id="preventive" className="scroll-mt-24">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  infestations occur. Regular inspections and treatment plans
                  help businesses avoid costly disruptions and maintain a safe
                  working environment.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-100">
                ...
                <p className="text-gray-700">
                  A single female cockroach can produce up to 30,000 offspring
                  per year, and rodents can chew through electrical wiring
                  causing fire hazards. Regular pest control prevents these
              ...
              >
                ...
                <p className="text-orange-100 leading-relaxed text-lg mb-6">
                  ...
                  uses safe, effective, and environmentally responsible methods
                  to keep your workplace pest‑free.
                </p>
              ...
              <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white p-8 rounded-2xl shadow-xl">
                ...
                <p className="text-gray-200 text-lg leading-relaxed">
                  ...
                  reputation while maintaining a healthier workplace. Partner
                  with Acuity Groups for proactive, reliable pest solutions.
                </p>
              </div>
