...
const PestManagementBlog = () => {
  ...
  useEffect(() => {
    ...
    updateMeta("og:image", "https://acuitygroups.com/static/media/ppp.jpg", true);
    updateMeta("og:url", "https://acuitygroups.com/blogs/pest-management", true);
    ...
    updateMeta("twitter:image", "https://acuitygroups.com/static/media/ppp.jpg");
    ...
    const breadcrumbData = {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Pest Management", item: "https://acuitygroups.com/blogs/pest-management" },
      ],
    };
  ...
  const shareUrl = encodeURIComponent("https://acuitygroups.com/blogs/pest-management");
  ...
  const stats = [
    { value: "200+", label: "Businesses Served", icon: <Building className="text-orange-600 w-6 h-6" /> },
    { value: "98%", label: "Pest Elimination Rate", icon: <Award className="text-orange-600 w-6 h-6" /> },
    { value: "24/7", label: "Emergency Support", icon: <Clock className="text-orange-600 w-6 h-6" /> },
    ...
    <div className="bg-gradient-to-br from-orange-50 via-white to-gray-50 text-gray-800 font-sans relative">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 md:p-8">
              <p className="text-xl text-gray-700 leading-relaxed border-l-4 border-orange-500 pl-5 italic">
                Pest infestations can seriously impact business operations, employee health, customer satisfaction, and brand reputation. Regular pest management helps organizations maintain safe, hygienic, and professional environments.
              </p>
            </div>
            ...
            <div className="my-2">
              ...
              <div className="flex justify-between items-center mt-2 text-sm text-gray-500">
                ...
                <span className="bg-orange-100 text-orange-700 px-2 py-0.5 rounded-full">Preventive Care</span>
              </div>
            </div>
            ...
            <div id="common-pests" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Bug size={28} className="text-orange-500" /> Common Pest Problems in Commercial Properties
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Offices, hotels, restaurants, warehouses, and industrial facilities often face challenges from rodents, cockroaches, termites, ants, mosquitoes, and other pests.
              </p>
            </div>
            ...
            <div id="benefits" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                <Shield size={28} className="text-orange-500" /> Key Benefits of Regular Pest Control
              </h2>
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  { title: "Health Protection", desc: "Reduce the spread of harmful bacteria and diseases carried by pests.", icon: Shield },
                  { title: "Property Protection", desc: "Prevent structural damage caused by termites and rodents.", icon: Building },
                  { title: "Regulatory Compliance", desc: "Meet hygiene and safety standards across industries (FSSAI, HACCP, ISO).", icon: CheckCircle },
                  { title: "Brand Reputation", desc: "Maintain customer trust with clean and pest‑free facilities.", icon: Sparkles },
                ].map((item, idx) => (
            ...
            <div id="preventive" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Leaf size={28} className="text-orange-500" /> Why Preventive Pest Control Matters
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Preventive pest management identifies potential risks before infestations occur. Regular inspections and treatment plans help businesses avoid costly disruptions and maintain a safe working environment.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-100">
              ...
              <p className="text-gray-700">
                A single female cockroach can produce up to 30,000 offspring per year, and rodents can chew through electrical wiring causing fire hazards. Regular pest control prevents these risks before they escalate.
              </p>
            </div>

            {/* Why Choose Acuity Groups */}
            <div id="why-acuity" className="bg-gradient-to-br from-orange-600 to-amber-700 text-white p-8 rounded-2xl shadow-xl scroll-mt-24">
              <h2 className="text-3xl font-bold mb-4">Why Choose Acuity Groups? 🐜</h2>
              <p className="text-orange-100 leading-relaxed text-lg mb-6">
                Acuity Groups offers professional pest management solutions tailored for offices, hotels, hospitals, commercial buildings, educational institutions, and industrial facilities. Our team uses safe, effective, and environmentally responsible methods to keep your workplace pest‑free.
              </p>
            ...
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white p-8 rounded-2xl shadow-xl">
              ...
              <p className="text-gray-200 text-lg leading-relaxed">
                Regular pest control is an essential part of facility management. By investing in professional pest management, businesses can protect employees, customers, assets, and their reputation while maintaining a healthier workplace. Partner with Acuity Groups for proactive, reliable pest solutions.
              </p>
            </div>
          ...
          <aside className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-100">
              <div className="w-24 h-24 mx-auto rounded-full overflow-hidden bg-gray-200 mb-4">
                <img src={Ppp4} alt="Pest Control Expert" className="w-full h-full object-cover" />
              </div>
              <h3 className="font-bold text-xl">Acuity Pest Control Team</h3>
              <p className="text-gray-500 text-sm mt-1">Pest Management Specialists</p>
              <p className="text-gray-600 text-sm mt-3">15+ years in commercial pest elimination.</p>
              ...
              <ul className="space-y-4">
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={Ppp2} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                  <Link to="/blogs/termite-control-guide" className="text-orange-600 group-hover:text-orange-700 group-hover:underline transition text-sm font-medium flex-1">
                    Termite Control Guide
                  </Link>
                </li>
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={Ppp3} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                  <Link to="/blogs/mosquito-prevention" className="text-orange-600 group-hover:text-orange-700 group-hover:underline transition text-sm font-medium flex-1">
                    Mosquito Prevention Tips
                  </Link>
                </li>
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={Ppp1} alt="thumb" className="w-full h-full object-cover" />
                  </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-100 rounded-2xl p-6 shadow-md border border-orange-100 text-center">
              ...
              <h3 className="font-bold text-orange-900 text-lg mb-2">Free Pest Assessment</h3>
              <p className="text-gray-700 text-sm mb-4">Identify risks before they become costly infestations.</p>
              ...
              <div className="mt-4 rounded-lg overflow-hidden">
                <img src={Ppp2} alt="Pest" className="w-full h-20 object-cover" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 text-center shadow-lg border">
              ...
              <p className="text-xs text-gray-500 mt-1">Safe | Eco‑friendly | Effective</p>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 border-t border-gray-200">
        ...
        <div className="space-y-4">
          {[
            { q: "Why is regular pest control important for businesses?", a: "It protects employee health, prevents property damage, ensures regulatory compliance, and safeguards brand reputation." },
            { q: "What pests are common in commercial properties?", a: "Rodents, cockroaches, termites, ants, mosquitoes, and stored product pests are typical in offices, hotels, restaurants, and warehouses." },
            { q: "How does Acuity Groups handle pest control?", a: "We use safe, eco‑friendly methods, regular inspections, and tailored treatment plans to eliminate pests and prevent re‑infestation." },
          ].map((faq, idx) => (
      ...
      <section className="relative bg-gradient-to-r from-orange-800 via-amber-800 to-orange-900 text-white py-16 text-center overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <img src={Ppp1} alt="background pattern" className="w-full h-full object-cover" />
        </div>
        <div className="relative max-w-3xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Keep Your Business Pest‑Free</h2>
          <p className="text-orange-100 text-lg mb-8">Contact Acuity Groups for professional, ongoing pest management.</p>
