...
const IntegratedDesignBlog = () => {
  ...
  useEffect(() => {
    // Title
    document.title =
      "Integrated Design & Facility Management: From Function to Feeling | Acuity Groups";
    ...
    canonical.href = "https://acuitygroups.in/blogs/FromFunction";
    ...
    ogTitle.setAttribute(
      "content",
      "Integrated Design: From Function to Feeling | Acuity Groups",
    );
    ...
    ogImage.setAttribute(
      "content",
      "https://acuitygroups.com/static/media/fff1.jpg",
    );
    ...
    ogUrl.setAttribute("content", "https://acuitygroups.in/blogs/FromFunction");
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white rounded-2xl shadow-md p-6 md:p-8">
              <p className="text-xl text-gray-700 leading-relaxed">
                The spaces we occupy have a powerful impact on our daily lives.
                A thoughtfully designed environment can inspire creativity,
                improve productivity, and promote well-being. Integrated design
                combines facility management and interior design to create
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                Whether it's a workplace, commercial building, or living space,
                design influences how people feel and perform. A well-planned
                environment enhances comfort, supports collaboration, and
                creates a positive experience for everyone who uses it.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                management with the creativity of interior design. This approach
                ensures that every space functions efficiently while also
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500 hover:shadow-lg transition">
                  ...
                  <p className="text-gray-600">
                    Colors, textures, artwork, and décor elements work together
                    to create a space that feels welcoming, inspiring, and
              ...
              <div className="grid md:grid-cols-3 gap-5">
                <div className="bg-white border p-5 rounded-xl shadow-sm hover:shadow-md transition text-center">
                  ...
                  <p className="text-gray-600 text-sm">
                    Designed to support productivity and meet operational needs.
                  </p>
                </div>
                <div className="bg-white border p-5 rounded-xl shadow-sm hover:shadow-md transition text-center">
                  <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
              ...
              <p className="text-gray-700 leading-relaxed">
                Well-designed spaces can increase employee productivity by up to
                20% and reduce absenteeism by 15%. Integrated design isn't just
                about aesthetics—it's a strategic investment in your
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-8 rounded-2xl">
              ...
              <p className="text-blue-50 text-lg leading-relaxed">
                At Acuity Groups, we combine facility management expertise with
                innovative interior design solutions to create spaces that are
                functional, beautiful, and sustainable. Our team works closely
                with clients to transform ordinary environments into spaces that
                support productivity, comfort, and long-term success.
              </p>
              <div className="mt-6">
                <Link
                  to="/contactus"
            ...
            <div className="bg-gradient-to-r from-blue-700 to-indigo-700 text-white p-8 rounded-2xl">
              ...
              <p className="text-blue-50 text-lg leading-relaxed">
                Integrated design goes beyond aesthetics. It creates spaces that
                improve functionality, enhance well-being, and support
