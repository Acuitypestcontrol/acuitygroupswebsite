...
const HealthcareFacilityManagementBlog = () => {
  ...
  useEffect(() => {
    ...
    updateMeta("og:image", "https://acuitygroups.com/static/media/healthcare-facility-banner.jpg", true);
    ...
    updateMeta("twitter:image", "https://acuitygroups.com/static/media/healthcare-facility-banner.jpg");
    ...
    const articleData = {
      ...
      image: "https://acuitygroups.com/static/media/healthcare-facility-banner.jpg",
    ...
    <div className="bg-gradient-to-br from-teal-50 via-white to-gray-50 text-gray-800 font-sans relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            {/* Service Cards */}
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-6">🔧 Core Facility Management Services</h2>
          ...
          <aside className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-100">
              <div className="w-24 h-24 mx-auto rounded-full overflow-hidden bg-gray-200 mb-4">
                <img src={supportTeam} alt="Healthcare FM Expert" className="w-full h-full object-cover" />
              </div>
              ...
              <ul className="space-y-4">
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={hospitalMgmt} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                ...
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={hospitalCleaning} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                ...
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={bannerImg} alt="thumb" className="w-full h-full object-cover" />
                  </div>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-2xl p-6 shadow-md border border-teal-100 text-center">
              ...
              <div className="mt-4 rounded-lg overflow-hidden">
                <img src={hospitalMgmt} alt="Healthcare" className="w-full h-20 object-cover" />
              </div>
            </div>
      ...
      <section className="relative bg-gradient-to-r from-teal-800 via-cyan-800 to-teal-900 text-white py-16 text-center overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <img src={bannerImg} alt="background pattern" className="w-full h-full object-cover" />
        </div>
