...
const CockroachInfestation = () => {
  ...
  useEffect(() => {
    ...
    canonical.href = "https://acuitygroups.in/blogs/cockroach-infestation";
    ...
    ogImage.setAttribute(
      "content",
      "https://acuitygroups.com/static/media/cockroach.jpg",
    );
    ...
    ogUrl.setAttribute(
      "content",
      "https://acuitygroups.in/blogs/cockroach-infestation",
    );
