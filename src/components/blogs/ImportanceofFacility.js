...
import Hospital2 from "../../images/hospital4webp.webp";
...
const HealthcareFacilityManagementBlog = () => {
  ...
  useEffect(() => {
    ...
    // Open Graph
    updateMeta("og:title", "The Importance of Facility Management in Healthcare Facilities | Acuity Groups", true);
    updateMeta("og:description", metaDescription, true);
    updateMeta("og:image", "https://acuitygroups.com/static/media/hospital1.webp", true);
    updateMeta("og:url", "https://acuitygroups.com/blogs/healthcare-facility-management", true);
    updateMeta("og:type", "article", true);
    updateMeta("og:site_name", "Acuity Groups", true);

    // Twitter Card
    updateMeta("twitter:card", "summary_large_image");
    updateMeta("twitter:title", "The Importance of Facility Management in Healthcare Facilities");
    updateMeta("twitter:description", metaDescription);
    updateMeta("twitter:image", "https://acuitygroups.com/static/media/hospital1.webp");
    ...
    canonical.href = "https://acuitygroups.com/blogs/healthcare-facility-management";
    ...
    const articleData = {
      ...
      image: "https://acuitygroups.com/static/media/hospital1.webp",
    ...
    const breadcrumbData = {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Healthcare Facility Management", item: "https://acuitygroups.com/blogs/healthcare-facility-management" },
      ],
    };
  ...
  const shareUrl = encodeURIComponent("https://acuitygroups.com/blogs/healthcare-facility-management");
  const shareTitle = encodeURIComponent("The Importance of Facility Management in Healthcare Facilities | Acuity Groups");
  ...
  const stats = [
    { value: "30+", label: "Hospitals Served", icon: <Building className="text-teal-600 w-6 h-6" /> },
    { value: "99%", label: "Compliance Rate", icon: <Award className="text-teal-600 w-6 h-6" /> },
    { value: "24/7", label: "Emergency Support", icon: <Clock className="text-teal-600 w-6 h-6" /> },
    { value: "15+", label: "Years Experience", icon: <Calendar className="text-teal-600 w-6 h-6" /> },
  ];
    ...
    <div className="bg-gradient-to-br from-teal-50 via-white to-gray-50 text-gray-800 font-sans relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="text-sm text-gray-500 mb-8" aria-label="Breadcrumb">
          <ol className="flex flex-wrap items-center gap-2">
            ...
            <li><Link to="/blogs/allblogs" className="hover:text-teal-600 transition">Blogs</Link></li>
            <li className="text-gray-400">/</li>
            <li className="text-gray-700 font-medium">Healthcare Facility Management</li>
          </ol>
        </nav>
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 md:p-8">
              <p className="text-xl text-gray-700 leading-relaxed border-l-4 border-teal-500 pl-5 italic">
                Healthcare facilities require the highest standards of cleanliness, safety, and operational efficiency. Effective facility management plays a critical role in supporting patient care while ensuring hospitals and healthcare centers operate smoothly.
              </p>
            </div>
            ...
            <div className="my-2">
              ...
              <div className="flex justify-between items-center mt-2 text-sm text-gray-500">
                ...
                <span className="bg-teal-100 text-teal-700 px-2 py-0.5 rounded-full">Core Service</span>
              </div>
            </div>
            ...
            <div id="patient-safety" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Heart size={28} className="text-teal-500" /> Supporting Patient Safety
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Clean and properly maintained healthcare environments help reduce infection risks and improve patient outcomes. Facility management ensures that critical systems (HVAC, medical gases, electrical backups) and support services remain reliable 24/7. A single lapse can lead to hospital-acquired infections, which affect 1 in 31 hospital patients on any given day.
              </p>
            </div>

            {/* Service Cards */}
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-6">🔧 Core Healthcare FM Services</h2>
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  { title: "Hygiene & Sanitization", desc: "Maintain infection-free environments through professional cleaning and disinfection protocols.", icon: Droplet },
                  { title: "Security Services", desc: "Protect patients, visitors, and healthcare staff with access control and surveillance.", icon: Shield },
                  { title: "Maintenance Support", desc: "Ensure uninterrupted operation of medical equipment and facility systems.", icon: Wrench },
                  { title: "Waste Management", desc: "Handle medical waste safely and compliantly, reducing environmental and health risks.", icon: Trash2 },
                ].map((service, idx) => (
                  <div key={idx} className="group bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500 hover:shadow-lg transition">
            ...
            <div id="compliance" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <CheckCircle size={28} className="text-teal-500" /> Maintaining Regulatory Compliance
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Healthcare facilities must comply with strict safety and hygiene regulations (OSHA, JCI, local health codes). Professional facility management helps ensure standards are consistently met while minimizing operational risks, avoiding fines, and protecting your reputation.
              </p>
            </div>
            ...
            <div id="benefits" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                <Sparkles size={28} className="text-teal-500" /> Key Benefits of Professional FM
              </h2>
            ...
            <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-2xl p-6 border border-teal-100">
              <h3 className="text-xl font-bold text-teal-800 mb-2 flex items-center gap-2">💡 Did You Know?</h3>
              <p className="text-gray-700">
                Proper facility management can reduce hospital-acquired infections by up to 30% and improve patient satisfaction scores by 25%. Investing in professional FM directly impacts your bottom line and reputation.
              </p>
            </div>

            {/* Why Acuity Groups */}
            <div id="why-acuity" className="bg-gradient-to-br from-teal-600 to-cyan-700 text-white p-8 rounded-2xl shadow-xl scroll-mt-24">
              <h2 className="text-3xl font-bold mb-4">Why Choose Acuity Groups for Healthcare FM? 🏥</h2>
              <p className="text-teal-100 leading-relaxed text-lg">
                Acuity Groups delivers specialized facility management solutions for hospitals, clinics, and long-term care facilities. From infection control and medical waste disposal to 24/7 maintenance and security, we ensure your healthcare environment is safe, compliant, and focused on healing.
              </p>
              <div className="mt-6 flex flex-wrap gap-4">
                <Link to="/contactus" className="inline-flex items-center gap-2 bg-white text-teal-700 px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition shadow-lg">
            ...
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white p-8 rounded-2xl shadow-xl">
              ...
              <p className="text-gray-200 text-lg leading-relaxed">
                Facility management is essential for delivering safe, efficient, and patient-focused healthcare services. Acuity Groups provides comprehensive healthcare facility solutions that support quality care and operational excellence. By partnering with us, you ensure your medical facility runs like a well-oiled machine — saving lives, one clean and safe environment at a time.
              </p>
            </div>

            {/* Back to blogs */}
            <div className="pt-4 border-t border-gray-200">
              <Link to="/blogs/allblogs" className="text-teal-600 hover:text-teal-700 font-medium inline-flex items-center gap-1">
                ← Back to all blogs
              </Link>
            </div>
          </div>
          ...
          <aside className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-100">
              <div className="w-24 h-24 mx-auto rounded-full overflow-hidden bg-gray-200 mb-4">
                <img src={Hospital2} alt="Healthcare FM Expert" className="w-full h-full object-cover" />
              </div>
              ...
              <p className="text-gray-600 text-sm mt-3">15+ years in healthcare facility management.</p>
              ...
              <ul className="space-y-4">
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={Hospital3} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                  <Link to="/blogs/TheImportanceFacilities" className="text-teal-600 group-hover:text-teal-700 group-hover:underline transition text-sm font-medium flex-1">
                    The Importance of Facilities Management
                  </Link>
                </li>
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={Hospital1} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                  <Link to="/blogs/FromFunction" className="text-teal-600 group-hover:text-teal-700 group-hover:underline transition text-sm font-medium flex-1">
                    Integrated Design: From Function to Feeling
                  </Link>
                </li>
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={Hospital2} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                  <Link to="/blogs/hotel-facility-management" className="text-teal-600 group-hover:text-teal-700 group-hover:underline transition text-sm font-medium flex-1">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-2xl p-6 shadow-md border border-teal-100 text-center">
              ...
              <h3 className="font-bold text-teal-900 text-lg mb-2">Trusted Healthcare Partner</h3>
              <p className="text-gray-700 text-sm mb-4">Get a free consultation for your hospital or clinic.</p>
              <Link to="/contactus" className="block text-center bg-teal-600 text-white py-2.5 rounded-full hover:bg-teal-700 transition shadow">
                Request a Quote
              </Link>
              <div className="mt-4 rounded-lg overflow-hidden">
                <img src={Hospital3} alt="Healthcare" className="w-full h-20 object-cover" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 text-center shadow-lg border">
              ...
              <p className="font-semibold text-gray-800">Trusted by 30+ Hospitals</p>
              <p className="text-xs text-gray-500 mt-1">Safe | Compliant | Caring</p>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 border-t border-gray-200">
        ...
        <div className="space-y-4">
          {[
            { q: "Why is facility management critical in healthcare?", a: "It ensures infection control, patient safety, regulatory compliance, and reliable operation of medical equipment and support services." },
            { q: "What services does Acuity Groups offer for healthcare facilities?", a: "Acuity Groups provides hygiene sanitization, security, maintenance, medical waste management, and integrated facility management tailored to hospitals and clinics." },
            { q: "How does facility management improve patient experience?", a: "Clean, safe, and well-maintained environments reduce stress, prevent infections, and create a healing atmosphere that improves overall patient satisfaction." },
          ].map((faq, idx) => (
            <div key={idx} className="bg-white rounded-xl shadow-md overflow-hidden">
              ...
              >
                {faq.q}
                <span className="text-teal-600 text-2xl">{activeFaq === idx ? "−" : "+"}</span>
              </button>
              {activeFaq === idx && (
      ...
      <section className="relative bg-gradient-to-r from-teal-800 via-cyan-800 to-teal-900 text-white py-16 text-center overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <img src={Hospital1} alt="background pattern" className="w-full h-full object-cover" />
        </div>
        <div className="relative max-w-3xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Elevate Your Healthcare Facility?</h2>
          <p className="text-teal-100 text-lg mb-8">Partner with Acuity Groups for professional facility management that puts patients first.</p>
          <div className="flex flex-wrap justify-center gap-5">
            <Link to="/contactus" className="inline-flex items-center gap-2 bg-white text-teal-800 px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition shadow-lg">
