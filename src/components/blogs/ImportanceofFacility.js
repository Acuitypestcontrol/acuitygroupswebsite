  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Enhance patient safety, infection control, and operational efficiency in your healthcare facility. Explore medical facility insights from Acuity Groups."
        />
        <meta
          name="keywords"
