...
const TheUnsungHeroesBlog = () => {
  ...
  useEffect(() => {
    ...
    canonical.href = "https://acuitygroups.in/blogs/the-unsung-heroes";
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div id="importance" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Building size={28} className="text-green-500" /> The Importance
                of Facilities
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Facilities are more than just buildings. They are the foundation
                of business operations, employee productivity, and customer
                experiences. Proper management ensures these spaces remain safe,
                functional, and efficient for everyone who uses them.
              </p>
            </div>
            ...
            <div id="fm-conductor" className="scroll-mt-24">
              ...
              <p className="text-gray-700 leading-relaxed">
                Facility management coordinates multiple services and processes
                to ensure seamless operations. Like a conductor leading an
                orchestra, facility managers bring together maintenance, safety,
                sustainability, and space planning to create a productive
                environment.
              </p>
            </div>
            ...
            <div id="impact" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                <Sparkles size={28} className="text-green-500" /> The Impact of
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100">
              ...
              <p className="text-gray-700">
                ...
                25% lower operating costs and 20% higher employee satisfaction.
                Investing in FM isn't an expense—it's a strategic advantage.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white p-8 rounded-2xl shadow-xl">
              ...
              <p className="text-gray-200 text-lg leading-relaxed">
                Facility management is the unseen force that keeps organizations
                running efficiently. By focusing on maintenance, safety,
                sustainability, and operational excellence, businesses can
                create environments that support growth, productivity, and
                long-term success. With Acuity Groups as your partner, you can
                ensure your facilities remain efficient, safe, and ready for the
                future.
              </p>
            </div>
