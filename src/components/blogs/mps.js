...
import Mps1 from "../../images/manpower (3).jpg";
import Mps2 from "../../images/manpower (2).jpg";
import Mps3 from "../../images/manpower (1).jpg";
...
const ManpowerOutsourcingBlog = () => {
  ...
  useEffect(() => {
    ...
    const articleData = {
      ...
      image: "https://acuitygroups.com/static/media/manpower%20(3).jpg",
