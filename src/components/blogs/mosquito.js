...
const MosquitoPrevention = () => {
  ...
  useEffect(() => {
    ...
    // Title & Meta
    document.title = "Mosquito Prevention Tips for a Healthier Home | Acuity Groups";
    ...
    // Open Graph
    updateMeta("og:title", "Mosquito Prevention Tips for a Healthier Home | Acuity Groups", true);
    updateMeta("og:description", metaDescription, true);
    updateMeta("og:image", "https://acuitygroups.com/static/media/mosquito.jpg", true);
    updateMeta("og:url", "https://acuitygroups.com/blogs/mosquito-prevention", true);
    updateMeta("og:type", "article", true);
    updateMeta("og:site_name", "Acuity Groups", true);

    // Twitter Card
    updateMeta("twitter:card", "summary_large_image");
    updateMeta("twitter:title", "Mosquito Prevention Tips for a Healthier Home");
    updateMeta("twitter:description", metaDescription);
    updateMeta("twitter:image", "https://acuitygroups.com/static/media/mosquito.jpg");
    ...
    canonical.href = "https://acuitygroups.com/blogs/mosquito-prevention";
    ...
    const articleData = {
      ...
      mainEntityOfPage: {
        "@type": "WebPage",
        "@id": "https://acuitygroups.com/blogs/mosquito-prevention",
      },
    };
    ...
    const breadcrumbData = {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Mosquito Prevention", item: "https://acuitygroups.com/blogs/mosquito-prevention" },
      ],
    };
  ...
  const shareUrl = encodeURIComponent("https://acuitygroups.com/blogs/mosquito-prevention");
  const shareTitle = encodeURIComponent("Mosquito Prevention Tips for a Healthier Home | Acuity Groups");
  ...
  const stats = [
    { value: "500+", label: "Families Protected", icon: <Home className="text-blue-600 w-6 h-6" /> },
    { value: "99%", label: "Mosquito Reduction", icon: <Award className="text-blue-600 w-6 h-6" /> },
    { value: "24/7", label: "Emergency Support", icon: <Clock className="text-blue-600 w-6 h-6" /> },
    ...
    <div className="bg-gradient-to-br from-blue-50 via-white to-gray-50 text-gray-800 font-sans relative">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 md:p-8">
              <p className="text-xl text-gray-700 leading-relaxed border-l-4 border-blue-500 pl-5 italic">
                Mosquitoes are not just annoying – they transmit deadly diseases like dengue, malaria, chikungunya, and Zika. Prevention is your first line of defence. Here's how to keep mosquitoes away from your home and family.
              </p>
            </div>

            {/* Key Takeaways Box */}
            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-6 border-l-8 border-blue-600">
              <p className="font-bold text-blue-900 text-xl mb-3 flex items-center gap-2">📌 Key Takeaways</p>
              <ul className="list-disc pl-5 text-gray-700 space-y-2">
                <li>Eliminate all standing water – mosquitoes breed in stagnant water</li>
                <li>Use mosquito nets and window screens for physical protection</li>
                <li>Apply EPA‑approved repellents (DEET, picaridin, or natural oils)</li>
                <li>Keep your surroundings clean – clear gutters, cover water tanks</li>
            ...
            <div className="my-2">
              ...
              <div className="flex justify-between items-center mt-2 text-sm text-gray-500">
                ...
                <span className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full">Health Risk</span>
              </div>
            </div>
            ...
            <div id="why-dangerous" className="scroll-mt-24">
              ...
              <ul className="space-y-2 list-disc pl-5 text-gray-700">
                <li><strong>Dengue:</strong> Causes high fever, joint pain, and can be fatal.</li>
                <li><strong>Malaria:</strong> Leads to recurrent fevers, anaemia, and organ failure.</li>
                <li><strong>Chikungunya:</strong> Severe joint pain that can last for months.</li>
                <li><strong>Zika virus:</strong> Linked to birth defects in pregnant women.</li>
              </ul>
            </div>
            ...
            <div id="breeding-sites" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Droplet size={28} className="text-blue-500" /> Where Mosquitoes Breed
              </h2>
              <p className="text-gray-700 leading-relaxed mb-3">Mosquitoes lay eggs in stagnant water. Common breeding sites include:</p>
            ...
            <div id="prevention-steps" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Shield size={28} className="text-blue-500" /> Effective Mosquito Prevention Steps
              </h2>
              <ul className="space-y-2 list-disc pl-5 text-gray-700">
                <li><strong>Remove standing water:</strong> Empty, scrub, or cover any water‑holding containers weekly.</li>
                <li><strong>Use mosquito nets:</strong> Sleep under treated nets, especially for children.</li>
                <li><strong>Install screens:</strong> Fit mesh screens on windows, doors, and vents.</li>
                <li><strong>Apply larvicides:</strong> Use mosquito dunks or natural larvicides in water tanks and drains.</li>
                <li><strong>Use repellents:</strong> Apply DEET, picaridin, or oil of lemon eucalyptus on exposed skin.</li>
                <li><strong>Wear protective clothing:</strong> Long sleeves and pants during peak mosquito hours (dawn & dusk).</li>
                <li><strong>Use coils, mats, or vapourisers:</strong> Indoors, especially at night.</li>
              </ul>
            </div>

            {/* Natural Repellent Recipe Box */}
            <div className="bg-amber-50 rounded-2xl p-6 border border-amber-200">
              <p className="font-bold text-amber-800 text-lg mb-2 flex items-center gap-2">💡 Natural Repellent Recipe</p>
              <p className="text-gray-700">Mix 10 drops each of citronella, eucalyptus, and lavender essential oils with 2 tablespoons of coconut oil. Apply to exposed skin – effective and chemical‑free.</p>
            </div>

            {/* Natural Repellent Plants */}
            <div id="natural-repellents" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Leaf size={28} className="text-blue-500" /> Natural Mosquito Repellent Plants
              </h2>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {["Citronella grass", "Lavender", "Marigolds", "Basil", "Rosemary", "Peppermint"].map((plant, i) => (
              ...
              <p className="text-gray-700 mt-3">Place these plants near windows, doors, and outdoor seating areas to naturally deter mosquitoes.</p>
            </div>

            {/* Long-Term Prevention */}
            <div id="long-term" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Home size={28} className="text-blue-500" /> Long‑Term Prevention Tips
              </h2>
              <ul className="space-y-2 list-disc pl-5 text-gray-700">
                <li>Keep your yard clean – remove piles of leaves and debris.</li>
                <li>Ensure proper drainage around your home – fill low‑lying areas.</li>
                <li>Cover water storage containers with tight lids.</li>
                <li>Clean gutters and downspouts regularly.</li>
                <li>Treat ornamental ponds with mosquito fish (gambusia) or larvicides.</li>
            ...
            <div id="professional" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                <Sparkles size={28} className="text-blue-500" /> When to Call a Professional
              </h2>
              <p className="text-gray-700 leading-relaxed mb-3">
                If your area has a high mosquito population or a dengue outbreak, DIY methods may not be enough. Professional mosquito control includes:
              </p>
              <ul className="space-y-2 list-disc pl-5 text-gray-700">
                <li>Fogging (thermal or cold) to kill adult mosquitoes instantly.</li>
                <li>Larvicide application to breeding sites (drains, water tanks).</li>
            ...
            <div className="bg-gradient-to-r from-blue-100 to-cyan-100 rounded-2xl p-6 text-center">
              <p className="font-bold text-blue-800 text-lg flex items-center justify-center gap-2">🦟 Did you know?</p>
              <p className="text-gray-700">Only female mosquitoes bite – they need blood protein to develop eggs. Males feed on nectar and are harmless to humans.</p>
            </div>

            {/* Final CTA text */}
            <div className="bg-blue-50 p-6 rounded-2xl text-center border border-blue-200">
              <p className="text-gray-800 text-lg">
                Don't let mosquitoes put your family at risk. Start with simple prevention steps, and if the problem persists, contact Acuity Groups for professional fogging and larvicide treatments.
              </p>
              <div className="mt-4">
                <Link to="/contactus" className="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-2 rounded-full font-semibold hover:bg-blue-700 transition shadow-md">
          ...
          <aside className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-100">
              <div className="w-24 h-24 mx-auto rounded-full overflow-hidden bg-gray-200 mb-4">
                <img src={Mosquito} alt="Pest Control Expert" className="w-full h-full object-cover" />
              </div>
              <h3 className="font-bold text-xl">Acuity Pest Control Team</h3>
              <p className="text-gray-500 text-sm mt-1">Mosquito Prevention Specialists</p>
              <p className="text-gray-600 text-sm mt-3">15+ years in mosquito control and disease prevention.</p>
              ...
              <ul className="space-y-4">
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={Mosquito} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                  <Link to="/blogs/pest-control-tips" className="text-blue-600 group-hover:text-blue-700 group-hover:underline transition text-sm font-medium flex-1">
                ...
                <li className="flex gap-3 items-center group">
                  ...
                  <Link to="/blogs/monsoon-health-safety" className="text-blue-600 group-hover:text-blue-700 group-hover:underline transition text-sm font-medium flex-1">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-100 rounded-2xl p-6 shadow-md border border-blue-100 text-center">
              ...
              <h3 className="font-bold text-blue-900 text-lg mb-2">Professional Mosquito Control</h3>
              <p className="text-gray-700 text-sm mb-4">Get a free inspection – fogging and source control available.</p>
              ...
              <div className="mt-4 rounded-lg overflow-hidden">
                <img src={Mosquito} alt="Mosquito" className="w-full h-20 object-cover" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 text-center shadow-lg border">
              ...
              <p className="font-semibold text-gray-800">Trusted by 500+ Families</p>
              <p className="text-xs text-gray-500 mt-1">Safe | Effective | Affordable</p>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 border-t border-gray-200">
        ...
        <div className="space-y-4">
          {[
            { q: "What is the most effective way to prevent mosquitoes?", a: "Eliminate standing water, use mosquito nets and window screens, apply EPA-approved repellents, and keep your surroundings clean." },
            { q: "Which natural repellents work against mosquitoes?", a: "Citronella, eucalyptus, lavender, neem oil, and lemon balm are effective natural repellents. You can also grow plants like marigolds and basil." },
            { q: "When should I call a professional mosquito control service?", a: "If DIY methods fail, or if your area has a high mosquito population or a dengue outbreak, professional fogging and larvicide treatments are recommended." },
          ].map((faq, idx) => (
      ...
      <section className="relative bg-gradient-to-r from-blue-800 via-cyan-800 to-blue-900 text-white py-16 text-center overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <img src={Mosquito} alt="background pattern" className="w-full h-full object-cover" />
        </div>
        <div className="relative max-w-3xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Mosquitoes Still a Problem?</h2>
          <p className="text-blue-100 text-lg mb-8">Get a free inspection – professional fogging and source control available.</p>
