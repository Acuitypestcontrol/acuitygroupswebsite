  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="mosquito prevention, dengue prevention, malaria control, mosquito repellent, fogging, pest control, Acuity Groups"
        />
        ...
        <meta
          property="og:title"
          content="Mosquito Prevention Tips for a Healthier Home | Acuity Groups"
        />
        <meta
        ...
        <meta
          name="twitter:title"
          content="Mosquito Prevention Tips for a Healthier Home"
        />
        <meta
            ...
            <div className="lg:col-span-6 space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-md p-6 md:p-8">
                <p className="text-xl text-gray-700 leading-relaxed border-l-4 border-blue-500 pl-5 italic">
                  Mosquitoes are not just annoying – they transmit deadly
                  diseases like dengue, malaria, chikungunya, and Zika.
                  Prevention is your first line of defence. Here's how to keep
                  mosquitoes away from your home and family.
                </p>
              </div>
              ...
              <div id="why-dangerous" className="scroll-mt-24">
                ...
                <ul className="space-y-2 list-disc pl-5 text-gray-700">
                  ...
                  <li>
                    <strong>Malaria:</strong> Leads to recurrent fevers,
                    anaemia, and organ failure.
                  </li>
                  <li>
                    <strong>Chikungunya:</strong> Severe joint pain that can
                    last for months.
                  </li>
                  <li>
              ...
              <div id="breeding-sites" className="scroll-mt-24">
                <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                  <Droplet size={28} className="text-blue-500" /> Where
                  Mosquitoes Breed
                </h2>
              ...
              <div id="prevention-steps" className="scroll-mt-24">
                ...
                <ul className="space-y-2 list-disc pl-5 text-gray-700">
                  <li>
                    <strong>Remove standing water:</strong> Empty, scrub, or
                    cover any water‑holding containers weekly.
                  </li>
                  <li>
                    <strong>Use mosquito nets:</strong> Sleep under treated
                    nets, especially for children.
                  </li>
                  <li>
                    <strong>Install screens:</strong> Fit mesh screens on
                  ...
                  <li>
                    <strong>Use repellents:</strong> Apply DEET, picaridin, or
                    oil of lemon eucalyptus on exposed skin.
                  </li>
                  <li>
              ...
              <div id="professional" className="scroll-mt-24">
                <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                  <Sparkles size={28} className="text-blue-500" /> When to Call
                  a Professional
                </h2>
                <p className="text-gray-700 leading-relaxed mb-3">
                ...
                <ul className="space-y-2 list-disc pl-5 text-gray-700">
                  <li>
                    Fogging (thermal or cold) to kill adult mosquitoes
                    instantly.
                  </li>
                  <li>
                    Larvicide application to breeding sites (drains, water
                    tanks).
                  </li>
              ...
              <div className="bg-gradient-to-r from-blue-100 to-cyan-100 rounded-2xl p-6 text-center">
                ...
                <p className="text-gray-700">
                  Only female mosquitoes bite – they need blood protein to
                  develop eggs. Males feed on nectar and are harmless to humans.
                </p>
              </div>
              ...
              <div className="bg-blue-50 p-6 rounded-2xl text-center border border-blue-200">
                <p className="text-gray-800 text-lg">
                  Don't let mosquitoes put your family at risk. Start with
                  simple prevention steps, and if the problem persists, contact
                  Acuity Groups for professional fogging and larvicide
                  treatments.
                </p>
                <div className="mt-4">
                  <Link
