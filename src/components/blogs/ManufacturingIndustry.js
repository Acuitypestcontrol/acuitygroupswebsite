...
const ManufacturingFacilityManagementBlog = () => {
  ...
  useEffect(() => {
    ...
    const metaDescription =
      "Discover how professional facility management enhances equipment reliability, workplace safety, operational efficiency, and compliance in manufacturing. Expert insights from Acuity Groups.";
    ...
    const articleData = {
      ...
      image: "https://acuitygroups.com/static/media/IndustrialFacility.jpg",
