...
// For now we use Unsplash placeholders with descriptive alt text
const bannerImg = "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&h=600&fit=crop";
const workforceImg = "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=800&h=500&fit=crop";
const staffingImg = "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=800&h=500&fit=crop";
const teamImg = "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=800&h=500&fit=crop";
...
const ManpowerOutsourcingBlog = () => {
  ...
  useEffect(() => {
    ...
    const metaDescription =
      "Discover how manpower outsourcing helps businesses reduce costs, access skilled talent, scale flexibly, and manage compliance. Expert insights from Acuity Groups.";
    ...
    updateMeta("og:image", bannerImg, true);
    updateMeta(
      "og:url",
      "https://acuitygroups.com/blogs/manpower-outsourcing",
      true
    );
    ...
    updateMeta("twitter:image", bannerImg);
    ...
    const breadcrumbData = {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: "https://acuitygroups.com/blogs/manpower-outsourcing",
        },
      ],
    };
          ...
          <aside className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 text-center border border-gray-100">
              <div className="w-24 h-24 mx-auto rounded-full overflow-hidden bg-gray-200 mb-4">
                <img src={teamImg} alt="Manpower Expert" className="w-full h-full object-cover" />
              </div>
              ...
              <ul className="space-y-4">
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={workforceImg} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                ...
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={staffingImg} alt="thumb" className="w-full h-full object-cover" />
                  </div>
                ...
                <li className="flex gap-3 items-center group">
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200 flex-shrink-0">
                    <img src={teamImg} alt="thumb" className="w-full h-full object-cover" />
                  </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-100 rounded-2xl p-6 shadow-md border border-indigo-100 text-center">
              ...
              <div className="mt-4 rounded-lg overflow-hidden">
                <img src={staffingImg} alt="Staffing" className="w-full h-20 object-cover" />
              </div>
            </div>
