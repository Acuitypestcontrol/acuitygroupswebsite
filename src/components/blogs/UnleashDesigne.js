  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="interior design trends 2024, home decor, biophilic design, sustainable interior, Japandi, grandmillennial, DIY home decor, Acuity Groups"
        />
        ...
        <meta
          property="og:title"
          content="Unleash Your Inner Designer: Top Tips & Trends for 2024 | Acuity Groups"
        />
        <meta
          property="og:description"
          content="Transform your home with the latest interior design trends for 2024: biophilic design, bold colors, sustainable choices, DIY projects, and trending styles like Japandi fusion."
        />
        <meta
          property="og:image"
        ...
        <meta
          name="twitter:title"
          content="Unleash Your Inner Designer: Top Tips & Trends for 2024"
        />
        <meta
            ...
            <div className="lg:col-span-6 space-y-8">
              ...
              <div id="comfort" className="scroll-mt-24">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  Modern interiors are designed to be both practical and
                  inviting. The goal is to create spaces that support everyday
                  living while maintaining a stylish appearance.
                </p>
              ...
              <div id="bold-colors" className="scroll-mt-24">
                <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                  <Palette size={28} className="text-orange-500" /> Play with
                  Bold Colors & Patterns
                </h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Bold design choices can instantly transform a room and make it
                  more expressive. Use colors and patterns strategically to
              ...
              <div id="diy" className="scroll-mt-24">
                <h2 className="text-3xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                  <Brush size={28} className="text-orange-500" /> DIY Projects
                  for a Personal Touch
                </h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Personal touches make a home truly unique. DIY projects can
                  add character and creativity without a large budget.
                </p>
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
              ...
              <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-100">
                ...
                <p className="text-gray-700">
                  ...
                  organic materials) have been shown to reduce stress by up to
                  40% and improve creativity by 25%. Nature-inspired interiors
                  aren't just beautiful—they're good for your health.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-orange-600 to-amber-700 text-white p-8 rounded-2xl shadow-xl">
                ...
                <p className="text-orange-100 text-lg leading-relaxed">
                  ...
                  creativity. By combining comfort, functionality,
                  sustainability, and modern design trends, you can create a
                  beautiful space that feels uniquely yours. At Acuity Groups,
                  we help bring your vision to life with affordable and
