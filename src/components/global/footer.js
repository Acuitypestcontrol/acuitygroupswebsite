...
export default function footer() {
  return (
    <div>
      <section
        class="py-20 sm:py-16 bg-gray-900"
      ...
      >
        <div class="container px-4 mx-auto">
          <div class="max-w-7xl mx-auto">
              ...
              <div class="flex flex-wrap -mx-4 items-center">
                <div class="w-full lg:w-1/2 px-4 mb-4 lg:mb-0">
                  <a class="inline-block" href="#">
                    <img class="h-28" src={Logo} alt="" />
                  </a>
                </div>
                <div class="w-full lg:w-1/2 px-4">
                  <div class="sm:flex -mb-4 items-center lg:justify-end">
                    {/* <a
                      class="inline-block mr-2 pb-5  rounded-md p-1"
                      href="https://www.facebook.com/profile.php?id=100083339978876"
                      target="_blank"
                    >
                      <svg
                        width="50px"
                      ...
                      >
                        <circle cx="24" cy="24" r="20" fill="#FC6A03" />
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                    ...
                    <a
                      class="inline-block mr-2 pb-5  rounded-md p-1"
                      href="https://www.instagram.com/_urban_nestproperties__/"
                      target="_blank"
                    >
                      <svg
                        width="50px"
                    ...
                    {/* <a
                      class="inline-block mr-2 pb-5  rounded-md p-1"
                      href="https://www.youtube.com/@vasukiventures6934"
                      target="_blank"
                    >
                      <svg
                        width="50px"
                    ...
                    <a
                      class="relative group inline-block w-full sm:w-auto py-3 px-5 mb-4 text-center text-sm font-semibold text-orange-50 hover:text-orange-900 bg-orange-600 rounded-md overflow-hidden transition duration-300"
                      href="/contact"
                    >
            ...
            <div class="flex flex-wrap pt-12 lg:-mx-6 items-center justify-center">
              <div class="px-6 mb-5">
                <a
                  class="inline-block text-gray-300 hover:text-gray-200"
                  href="/"
                >
                  Home
                </a>
            ...
            <div class="mt-15 text-center">
              <span class="text-orange-600">
                &copy; Urban Nest Propertiess. All rights reserved.
                <br />
                {/* <a href="https://1990minds.com/" target="_blank">
                  Designed by 1990minds
                </a> */}
              </span>
            </div>
          </div>
