...
const ContactUs = () => {
  useEffect(() => {
    document.title =
      "Contact Us | Acuity Groups - Facility Management Services";
    window.scrollTo(0, 0);
  }, []);
      ...
      <section className="relative bg-gradient-to-br from-blue-900 to-blue-700 text-white py-24 md:py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Have questions or need a quote? Our team is ready to assist you with
            professional facility management and security solutions.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 md:px-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8">
            Follow us for updates, service announcements, and industry insights.
          </p>
