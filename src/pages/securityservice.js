  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Secure your property with top-tier security services in Bangalore. Trained personnel, access control, and 24/7 surveillance for your peace of mind."
        />
        <meta
          name="keywords"
          content="security services, manned guarding, corporate security, residential security, industrial security, event security, CCTV monitoring, Bangalore, Acuity Groups"
        />
        ...
        <meta
          property="og:title"
          content="Professional Security Services | Manned Guarding & Corporate Security | Acuity Groups"
        />
        <meta
          property="og:description"
          content="Professional security services for commercial, residential, industrial, and corporate facilities. Trained security personnel and 24/7 surveillance."
        />
        <meta
          property="og:image"
        ...
        <meta
          name="twitter:title"
          content="Professional Security Services | Acuity Groups"
        />
        <meta
          name="twitter:description"
          content="Reliable security services – manned guarding, corporate security, residential protection, and CCTV monitoring."
        />
        <meta
          name="twitter:image"
          content="https://www.acuitygroups.in/static/media/security12.jpg"
