...
const FacilityManagement = () => {
  const canonicalUrl = "https://www.acuitygroups.in/facilitymanagment1";
    ...
    <div className="overflow-hidden bg-white font-sans text-gray-800">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-24 md:px-12">
          ...
          >
            <motion.div
              variants={fadeUp}
              transition={springy}
              className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-5 py-2 text-sm font-semibold backdrop-blur-md"
            >
            ...
            <motion.p
              variants={fadeUp}
              transition={springy}
              className="mb-10 max-w-2xl text-lg leading-relaxed text-blue-100 md:text-xl"
            >
          ...
          <div className="grid gap-7 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service, i) => (
              <motion.article
                ...
                variants={fadeUp}
                transition={{ ...springy, delay: (i % 3) * 0.1 }}
      ...
      <section className="bg-white px-6 py-24 md:px-12">
        <motion.div
          ...
          className="mx-auto grid max-w-7xl items-center gap-12 rounded-[40px] bg-blue-950 p-8 text-white md:p-14 lg:grid-cols-2"
        >
      ...
      <section className="bg-gray-50 px-6 py-24 md:px-12">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {serviceAreas.map((area, i) => (
              <motion.div
                ...
                viewport={{ once: false, amount: 0.4 }}
                variants={scaleIn}
                transition={{ ...bouncy, delay: (i % 4) * 0.06 }}
              >
                <Link
                  to={area.path}
                  aria-label={`Facility management services in ${area.name}`}
                  className="group block h-full rounded-2xl border border-gray-100 bg-white p-5 text-center transition hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg"
                >
                  <MapPin
          ...
          <motion.div
            ...
            variants={fadeUp}
            transition={springy}
            className="mx-auto mt-12 max-w-5xl rounded-3xl border border-blue-100 bg-blue-50 p-7 md:p-10"
          >
      ...
      <section className="bg-white px-6 py-24 md:px-12">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {industries.map((industry, i) => (
              <motion.div
                ...
                viewport={{ once: false, amount: 0.4 }}
                variants={scaleIn}
                transition={{ ...bouncy, delay: (i % 3) * 0.08 }}
          ...
          <motion.div
            ...
            variants={fadeUp}
            transition={springy}
            className="mx-auto mt-12 max-w-5xl rounded-3xl bg-blue-50 p-7 md:p-10"
          >
            <h3 className="mb-5 text-center text-3xl font-black text-gray-900">
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="group block h-full rounded-3xl border border-gray-100 bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-xl"
                  >
      ...
      <section className="bg-white px-6 py-24 md:px-12">
        <div className="mx-auto max-w-4xl">
            ...
            {faqs.map((faq, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="overflow-hidden rounded-2xl border border-gray-100 bg-gray-50 shadow-sm transition hover:shadow-md"
                >
                  <button
                    type="button"
                    onClick={() => setOpenFaq(isOpen ? null : i)}
                    aria-expanded={isOpen}
                    className="flex w-full cursor-pointer items-center justify-between gap-4 p-6 text-left font-bold text-gray-900"
                  >
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <p className="border-t border-gray-200 px-6 pb-6 pt-4 leading-relaxed text-gray-600">
                          {faq.answer}
                        </p>
                      </motion.div>
                    )}
          ...
          <motion.div
            ...
            variants={fadeUp}
            transition={springy}
            className="mt-10 rounded-3xl border border-blue-100 bg-blue-50 p-7 text-center"
          >
      ...
      <section className="bg-gray-50 px-6 py-20 md:px-12">
        <motion.div
          ...
          variants={fadeUp}
          transition={springy}
          className="mx-auto grid max-w-7xl gap-8 rounded-[36px] border border-gray-100 bg-white p-8 shadow-sm lg:grid-cols-2 lg:p-12"
        >
          <div>
            <div className="mb-5 inline-flex items-center gap-2 rounded-full bg-blue-50 px-5 py-2 text-sm font-bold text-blue-900">
              <MapPin size={16} />
      ...
      <section className="bg-gray-50 px-6 pb-24 pt-8 md:px-12">
        <motion.div
          ...
          variants={scaleIn}
          transition={bouncy}
          className="mx-auto max-w-5xl rounded-[40px] bg-white px-7 py-16 text-center shadow-sm md:px-12"
        >
