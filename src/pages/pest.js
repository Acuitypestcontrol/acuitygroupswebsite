...
const PestManagement = () => {
  useEffect(() => {
    document.title =
      "Pest Management Services | Termite, Rodent & Mosquito Control";
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Using eco-friendly products and advanced techniques, we protect
                your property from cockroaches, termites, rodents, mosquitoes,
                bed bugs, and other pests while ensuring the safety of your
                family, employees, and pets.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-gray-900">
              Our Pest{" "}
              <span className="bg-gradient-to-r from-blue-900 to-blue-900 blue-900 bg-clip-text text-transparent">
                Management Services
              </span>
            </h2>
      ...
      <section className="py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto mt-4">
              We deliver excellence through quality, safety, and professionalism
            </p>
          </div>
